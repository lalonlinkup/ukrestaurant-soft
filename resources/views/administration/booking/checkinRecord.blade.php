@extends('master')
@section('title', 'Checkin Record')
@section('breadcrumb_title', 'Checkin Record')
@push('style')
<style scoped>
...
<div id="bookingRecord">
    <div class="row" style="margin:0;">
        <fieldset class="scheduler-border bg-of-skyblue">
            <legend class="scheduler-border">Search Checkin Record</legend>
            <div class="control-group">
                <form @submit.prevent="getCheckin">
