...
@section('breadcrumb_title', 'Loan Ledger')
@push('style')
<style scoped>
...
<div id="loanLedger">
    ...
    <div class="row" style="display:none;" v-bind:style="{display: transactions.length > 0 && showReport ? '' : 'none'}" v-if="transactions.length > 0">
                ...
                <table class="table table-bordered table-condensed" id="transactionsTable">
                    ...
                    <tbody>
                        ...
                        <tr v-for="(transaction, sl) in transactions">
                            ...
                            <td style="text-align:right">@{{ transaction.interest | decimal }}</td>
                        ...
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">@{{ transactions.reduce((p, c) => { return +p + +c.interest }, 0) | decimal }}</td>
    ...
    var loanLedger = new Vue({
        ...
        computed: {
            computedAccounts() {
                ...
                return accounts.map(account => {
                    account.display_name = `${account.number} (${account.bank_name})`;
                    return account;
                })
            }
        },
        ...
        methods: {
            ...
            getTransactions() {
                ...
                axios.post('/get-loan-ledger', this.filter)
                    .then(res => {
            ...
            async print() {
                ...
                let reportContent = `
                        <div class="container">
                            <h4 style="text-align:center">Loan Ledger</h4 style="text-align:center">
                            <div class="row">
