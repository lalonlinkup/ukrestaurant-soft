@extends('master')
@section('title', 'Investment Account Entry')
@section('breadcrumb_title', 'Investment Account Entry')
@section('content')
<div id="Accounts">
    <div class="row">
        <div class="col-md-4 col-xs-12 col-md-offset-4 no-padding">
            <div class="card">
                <div class="card-header">
                    <strong><i class="fa fa-file-text" aria-hidden="true"></i> &nbsp;Investment Account Information</strong>
                </div>
                <div class="card-body">
...
<script>
    var Accounts = new Vue({
        ...
        methods: {
            ...
            saveAccount() {
                let url = '/add-investment-account';
                if (this.account.id != null) {
                    url = '/update-investment-account';
                }
            ...
            deleteAccount(accountId) {
                if (confirm("Are you sure !!")) {
                    axios.post("/delete-investment-account", {
                            id: accountId
                        })
                        .then(res => {
                            toastr.success(res.data.message)
