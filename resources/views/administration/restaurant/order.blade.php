...
@section('breadcrumb_title', 'Order Entry')
@push('style')
    <style>
        .sidebar-nav {
            margin: 5px 0px;
                        ...
                        <div class="row" style="margin:0;">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <select id="customerType" v-model="customerType" class="form-control" @change="onChangeType">
                                        ...
                                        <option value="room">Room Guest</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <v-select style="display: none;" :style="{display: customerType == 'room' ? '' : 'none' }" :options="rooms" id="room" v-model="selectedRoom" @input="onChangeRoom" label="name"></v-select>
                            ...
                            <div class="form-group" class="form-group" v-if=" customerType == 'room' || customerType == 'existing'" style="display: none;" :style="{display: customerType == 'room' || customerType == 'existing' ? '' : 'none' }">
        ...
        new Vue({
            ...
            methods: {
                onChangeType(event) {
                    ...
                    } else if(this.customerType == 'room') {
                        this.label = 'Room';
                        this.getRooms();
                        this.selectedCustomer = {
                            id: '',
                ...
                async onChangeRoom() {
                    ...
                    await axios.post('/get-checkin-list', {
                        ...
                        if(!r) {
                            ...
                            this.selectedCustomer = {
                                id: r.customers.customer_id,
                                code: r.customers.customer_code,
                                name: r.customers.customer_name,
                                display_name: r.customers.customer_name,
                                phone: r.customers.customer_phone,
                                address: r.customers.customer_address,
                                bookingId: r.details[0].booking_id,
                                type: 'retail'
                            }
                ...
                async getRooms() {
                    await axios.get('/get-room').then(res => {
                        this.rooms = res.data;
                    })
                },
                ...
                async saveOrder() {
                    if(this.customerType == 'room' && this.selectedRoom == null) {
                    ...
                    this.order.room_id = this.selectedRoom != null ? this.selectedRoom.id : "";
                    if(this.selectedRoom != null) {
                        this.order.booking_id = this.selectedCustomer.bookingId;
                    } else {
                        this.order.booking_id = '';
                    }
